...
class ItemDetailViewController: UITableViewController, UITextFieldDelegate {
            ...
            if indexPath.section == 1 && indexPath.row == 2 {
                var cell: UITableViewCell! =
                    tableView.dequeueReusableCellWithIdentifier(
                        "DatePickerCell") as? UITableViewCell
    ...
    // adding this function is necessary to prevent the app from crashing when a
    // user tries to use the date picker
    override func tableView(tableView: UITableView,
    ...
    func showDatePicker() {
        ...
        if let pickerCell =
            tableView.cellForRowAtIndexPath(indexPathDatePicker) {
